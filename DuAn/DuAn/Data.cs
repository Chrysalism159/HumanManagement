...
namespace DuAn
{
    public partial class Data : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\HumanManagementSystem\Database\EmployeeDb.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        private void DataTable_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            EDU.Text = DataTable.SelectedRows[0].Cells[4].Value.ToString();
